...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://Alan:Agonzalez3@localhost/Base_Datos_beta2'
...
class Usuario(db.Model):
    ...
    contraseña = db.Column('contraseña', db.String(10), nullable=False)
...
#    usuarios = Usuario.query.all()
#    usuarios_json = [{'id': usuario.id, 'nombre': usuario.nombre, 'email': usuario.email, 'contraseña':usuario.contraseña} for usuario in usuarios]
